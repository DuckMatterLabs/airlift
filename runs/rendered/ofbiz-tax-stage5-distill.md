...
* `/Volumes/Dancer/Develop/AIRLIFT/airlift/out/ofbiz-tax/behavior-catalog.yaml`
* `/Volumes/Dancer/Develop/AIRLIFT/airlift/out/ofbiz-tax/backfill-report.yaml` — including catalog corrections discovered while pinning
* `/Volumes/Dancer/Develop/AIRLIFT/airlift/targets/ofbiz-tax/harness/harness-contract.md` — the fixture vocabulary your domain model must align with.
...
Emit the complete Airlift IR for the seam into `/Volumes/Dancer/Develop/AIRLIFT/airlift/out/ofbiz-tax/ir/`, per the schema:
...
Write only under `/Volumes/Dancer/Develop/AIRLIFT/airlift/out/ofbiz-tax/ir/` plus the comment annotations in the primary source
file(s).
