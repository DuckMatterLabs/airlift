---
confidence: proven
related: [tests/out/ofbiz-tax/RUN-REPORT.md, spec/planning/Goal1-handoff.md]
sources: [tests/out/ofbiz-tax/RUN-REPORT.md]
trajectory: >
  The Goal-1 spike's component map and proof-run summary, moved from the repo
  root 2026-07-19 when the root README became the human-facing pitch. Frozen
  as run-adjacent reference; operational truth lives in Goal1-handoff.md.
---

# Airlift — business-logic distillation pipeline (Goal-1 spike reference)
