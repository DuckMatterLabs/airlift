...
## REPAIR ROUND
Your previous output failed deterministic validation. Fix your existing output files in place (do not start over):

```
ir-manifest: schema_version 0.9 not supported by these validators (supported: 1.0)
[validate:ir] FAIL 1 violations
```
